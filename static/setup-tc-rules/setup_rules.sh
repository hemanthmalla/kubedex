...
then
    tc class add dev eth0 parent 1: classid 1:$subscriber_id htb rate 10000kbit ceil 10000kbit 
fi    

tc class add dev eth0 parent 1:$subscriber_id classid 1:$topic_id htb rate 10000kbit ceil 10000kbit prio $priority
